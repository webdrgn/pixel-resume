import{s as N}from"./PSV9uH-m.js";import{ab as T,by as m,f as K,A as i,B as c,C as l,b7 as z,a7 as r,a4 as b,ap as y,a6 as h,I as f,J as k,E as O,bz as P}from"./B69HVJWc.js";import{s as S}from"./CIv15fAi.js";import{s as x}from"./k7zgCda4.js";import"./C8O1kECu.js";var B=`
...
`,j={root:"p-organizationchart p-component",table:"p-organizationchart-table",node:function(e){var t=e.instance;return["p-organizationchart-node",{"p-organizationchart-node-selectable":t.selectable,"p-organizationchart-node-selected":t.selected}]},nodeToggleButton:function(e){var t=e.instance;return["p-organizationchart-node-toggle-button",{"p-disabled":!t.selectable}]},nodeToggleButtonIcon:"p-organizationchart-node-toggle-button-icon",connectors:"p-organizationchart-connectors",connectorDown:"p-organizationchart-connector-down",connectorLeft:function(e){var t=e.index;return["p-organizationchart-connector-left",{"p-organizationchart-connector-top":t!==0}]},connectorRight:function(e){var t=e.props,a=e.index;return["p-organizationchart-connector-right",{"p-organizationchart-connector-top":a!==t.node.children.length-1}]},nodeChildren:"p-organizationchart-node-children"},D=T.extend({name:"organizationchart",style:B,classes:j}),M={name:"BaseOrganizationChart",extends:N,props:{value:{type:null,default:null},selectionKeys:{type:null,default:null},selectionMode:{type:String,default:null},collapsible:{type:Boolean,default:!1},collapsedKeys:{type:null,default:null}},style:D,provide:function(){return{$pcOrganizationChart:this,$parentInstance:this}}},w={name:"OrganizationChartNode",hostName:"OrganizationChart",extends:N,emits:["node-click","node-toggle"],props:{node:{type:null,default:null},templates:{type:null,default:null},collapsible:{type:Boolean,default:!1},collapsedKeys:{type:null,default:null},selectionKeys:{type:null,default:null},selectionMode:{type:String,default:null}},methods:{getPTOptions:function(e){return this.ptm(e,{context:{expanded:this.expanded,selectable:this.selectable,selected:this.selected,toggleable:this.toggleable,active:this.selected}})},getNodeOptions:function(e,t){return this.ptm(t,{context:{lineTop:e}})},onNodeClick:function(e){m(e.target,"data-pc-section","nodetogglebutton")||m(e.target,"data-pc-section","nodetogglebuttonicon")||this.selectionMode&&this.$emit("node-click",this.node)},onChildNodeClick:function(e){this.$emit("node-click",e)},toggleNode:function(){this.$emit("node-toggle",this.node)},onChildNodeToggle:function(e){this.$emit("node-toggle",e)},onKeydown:function(e){(e.code==="Enter"||e.code==="NumpadEnter"||e.code==="Space")&&(this.toggleNode(),e.preventDefault())}},computed:{leaf:function(){return this.node.leaf===!1?!1:!(this.node.children&&this.node.children.length)},colspan:function(){return this.node.children&&this.node.children.length?this.node.children.length*2:null},childStyle:function(){return{visibility:!this.leaf&&this.expanded?"inherit":"hidden"}},expanded:function(){return this.collapsedKeys[this.node.key]===void 0},selectable:function(){return this.selectionMode&&this.node.selectable!==!1},selected:function(){return this.selectable&&this.selectionKeys&&this.selectionKeys[this.node.key]===!0},toggleable:function(){return this.collapsible&&this.node.collapsible!==!1&&!this.leaf}},components:{ChevronDownIcon:S,ChevronUpIcon:x}},I=["colspan"],E=["colspan"],L=["colspan"];function R(n,e,t,a,s,o){var p=K("OrganizationChartNode",!0);return i(),c("table",r({class:n.cx("table")},n.ptm("table")),[l("tbody",z(P(n.ptm("body"))),[t.node?(i(),c("tr",z(r({key:0},n.ptm("row"))),[l("td",r({colspan:o.colspan},n.ptm("cell")),[l("div",r({class:[n.cx("node"),t.node.styleClass],onClick:e[2]||(e[2]=function(){return o.onNodeClick&&o.onNodeClick.apply(o,arguments)})},o.getPTOptions("node")),[(i(),b(y(t.templates[t.node.type]||t.templates.default),{node:t.node},null,8,["node"])),o.toggleable?(i(),c("a",r({key:0,tabindex:"0",class:n.cx("nodeToggleButton"),onClick:e[0]||(e[0]=function(){return o.toggleNode&&o.toggleNode.apply(o,arguments)}),onKeydown:e[1]||(e[1]=function(){return o.onKeydown&&o.onKeydown.apply(o,arguments)})},o.getPTOptions("nodeToggleButton")),[t.templates.toggleicon||t.templates.togglericon?(i(),b(y(t.templates.toggleicon||t.templates.togglericon),r({key:0,expanded:o.expanded,class:n.cx("nodeToggleButtonIcon")},o.getPTOptions("nodeToggleButtonIcon")),null,16,["expanded","class"])):(i(),b(y(o.expanded?"ChevronDownIcon":"ChevronUpIcon"),r({key:1,class:n.cx("nodeToggleButtonIcon")},o.getPTOptions("nodeToggleButtonIcon")),null,16,["class"]))],16)):h("",!0)],16)],16,I)],16)):h("",!0),l("tr",r({style:o.childStyle,class:n.cx("connectors")},n.ptm("connectors")),[l("td",r({colspan:o.colspan},n.ptm("lineCell")),[l("div",r({class:n.cx("connectorDown")},n.ptm("connectorDown")),null,16)],16,E)],16),l("tr",r({style:o.childStyle,class:n.cx("connectors")},n.ptm("connectors")),[t.node.children&&t.node.children.length===1?(i(),c("td",r({key:0,colspan:o.colspan},n.ptm("lineCell")),[l("div",r({class:n.cx("connectorDown")},n.ptm("connectorDown")),null,16)],16,L)):h("",!0),t.node.children&&t.node.children.length>1?(i(!0),c(f,{key:1},k(t.node.children,function(g,u){return i(),c(f,{key:g.key},[l("td",r({class:n.cx("connectorLeft",{index:u})},{ref_for:!0},o.getNodeOptions(u!==0,"connectorLeft"))," ",16),l("td",r({class:n.cx("connectorRight",{index:u})},{ref_for:!0},o.getNodeOptions(u!==t.node.children.length-1,"connectorRight"))," ",16)],64)}),128)):h("",!0)],16),l("tr",r({style:o.childStyle,class:n.cx("nodeChildren")},n.ptm("nodeChildren")),[(i(!0),c(f,null,k(t.node.children,function(g){return i(),c("td",r({key:g.key,colspan:"2"},{ref_for:!0},n.ptm("nodeCell")),[O(p,{node:g,templates:t.templates,collapsedKeys:t.collapsedKeys,onNodeToggle:o.onChildNodeToggle,collapsible:t.collapsible,selectionMode:t.selectionMode,selectionKeys:t.selectionKeys,onNodeClick:o.onChildNodeClick,pt:n.pt,unstyled:n.unstyled},null,8,["node","templates","collapsedKeys","onNodeToggle","collapsible","selectionMode","selectionKeys","onNodeClick","pt","unstyled"])],16)}),128))],16)],16)],16)}w.render=R;function d(n){"@babel/helpers - typeof";return d=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},d(n)}function v(n,e){var t=Object.keys(n);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(n);e&&(a=a.filter(function(s){return Object.getOwnPropertyDescriptor(n,s).enumerable})),t.push.apply(t,a)}return t}function C(n){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?v(Object(t),!0).forEach(function(a){V(n,a,t[a])}):Object.getOwnPropertyDescriptors?Object.defineProperties(n,Object.getOwnPropertyDescriptors(t)):v(Object(t)).forEach(function(a){Object.defineProperty(n,a,Object.getOwnPropertyDescriptor(t,a))})}return n}function V(n,e,t){return(e=A(e))in n?Object.defineProperty(n,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):n[e]=t,n}function A(n){var e=U(n,"string");return d(e)=="symbol"?e:e+""}function U(n,e){if(d(n)!="object"||!n)return n;var t=n[Symbol.toPrimitive];if(t!==void 0){var a=t.call(n,e);if(d(a)!="object")return a;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(n)}var F={name:"OrganizationChart",extends:M,inheritAttrs:!1,emits:["node-unselect","node-select","update:selectionKeys","node-expand","node-collapse","update:collapsedKeys"],data:function(){return{d_collapsedKeys:this.collapsedKeys||{}}},watch:{collapsedKeys:function(e){this.d_collapsedKeys=e}},methods:{onNodeClick:function(e){var t=e.key;if(this.selectionMode){var a=this.selectionKeys?C({},this.selectionKeys):{};a[t]?(delete a[t],this.$emit("node-unselect",e)):(this.selectionMode==="single"&&(a={}),a[t]=!0,this.$emit("node-select",e)),this.$emit("update:selectionKeys",a)}},onNodeToggle:function(e){var t=e.key;this.d_collapsedKeys[t]?(delete this.d_collapsedKeys[t],this.$emit("node-expand",e)):(this.d_collapsedKeys[t]=!0,this.$emit("node-collapse",e)),this.d_collapsedKeys=C({},this.d_collapsedKeys),this.$emit("update:collapsedKeys",this.d_collapsedKeys)}},components:{OrganizationChartNode:w}};function J(n,e,t,a,s,o){var p=K("OrganizationChartNode");return i(),c("div",r({class:n.cx("root")},n.ptmi("root")),[O(p,{node:n.value,templates:n.$slots,onNodeToggle:o.onNodeToggle,collapsedKeys:s.d_collapsedKeys,collapsible:n.collapsible,onNodeClick:o.onNodeClick,selectionMode:n.selectionMode,selectionKeys:n.selectionKeys,pt:n.pt,unstyled:n.unstyled},null,8,["node","templates","onNodeToggle","collapsedKeys","collapsible","onNodeClick","selectionMode","selectionKeys","pt","unstyled"])],16)}F.render=J;export{F as default};
